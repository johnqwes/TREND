...
def main():
    ...
    # Create a session state object
     ...
     if st.session_state.user is None:
        ...
        tabs = st.sidebar.radio("SELECT TAB:", ["📊 Dashboard", ":chart_with_upwards_trend: Enrollment", ":chart_with_downwards_trend: Dropout", "🎓 Graduate", "🆕 Manage Data"])
                ...
                if sy_input != 0 and id_input != 0:
                    ...
                    if len(filtered_data) > 0:
                       ...
                       # Display predicted value for the input year
                        if sy_input != 2023 or (sy_input == 2023 and original_value is None):
                            fig.add_trace(go.Scatter(
                                x=[sy_input],
                                y=[predictions[0]],
                                mode='markers',
                ...
                if sy_input != 0 and id_input != 0:
                    ...
                    if len(filtered_data) > 0:
                        ...
                        fig.add_trace(go.Scatter(
                            ...
                            mode='markers',
                            name='Predicted Value',
                            marker=dict(color='#4CAF50', size=16, symbol='star' if original_value is None else 'circle', line=dict(color='#000000', width=1.5)),
                        ))
